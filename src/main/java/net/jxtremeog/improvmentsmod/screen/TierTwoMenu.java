...
import static net.jxtremeog.improvmentsmod.block.entity.TierTwoBlockEntity.numberOfSlots;

public class TierTwoMenu extends AbstractContainerMenu {
    public final TierTwoBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public TierTwoMenu(int id, Inventory inv, FriendlyByteBuf extraData){
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()),
                new SimpleContainerData(2));
    }
    public TierTwoMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.TIERTWO_MENU.get(), id);
        checkContainerSize(inv, numberOfSlots);
        blockEntity = (TierTwoBlockEntity) entity;
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = numberOfSlots;  // must be the number of slots you have!
