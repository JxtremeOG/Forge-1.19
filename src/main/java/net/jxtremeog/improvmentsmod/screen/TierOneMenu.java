...
public class TierOneMenu extends AbstractContainerMenu {
    public final TierOneBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public TierOneMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(3));
    }

    public TierOneMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.TIERONE_MENU.get(), id);
        checkContainerSize(inv, 10);
        blockEntity = (TierOneBlockEntity) entity;
